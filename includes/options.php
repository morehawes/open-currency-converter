...
if ((! empty($_POST)) && (check_admin_referer('options', 'open_currency_converter_options_nonce'))) {
	...
	if (isset($_POST['occ_thousands_separator'])) {$options['thousands_separator'] = sanitize_text_field($_POST['occ_thousands_separator']);}
...
<?php
if (is_array($rates_array) && is_array($codes_array)) {
...
<tr>
<th scope="row"><?php _e('Thousands Separator', 'artiss-currency-converter'); ?></th>
<td><label for="occ_thousands_separator"><select name="occ_thousands_separator">
<option value=","<?php if ($options['thousands_separator'] === ',') {echo " selected='selected'";}?>>,</option>
<option value="."<?php if ($options['thousands_separator'] === '.') {echo " selected='selected'";}?>>.</option>
<option value=""<?php if ($options['thousands_separator'] === '') {echo " selected='selected'";}?>><?php _e('None', 'artiss-currency-converter'); ?></option>
</select><?php _e('The thousands separator to use', 'artiss-currency-converter'); ?></label>
</td>
</tr>
